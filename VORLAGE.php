<?php
$titel = 'Azadi Berlin - FRAU LEBEN FREIHEIT';
...
<!-- Inhalt //-->
	<div class="container">
		...
		<div class="image-text-block">
			<!-- Linkes div mit zentriertem Bild -->
			<div class="image-container">
				<img src="images/vorlage_image330x330.png" alt="Zentriertes Bild">
			</div>
			<!-- Rechtes div mit Überschrift, Text und Link -->
			<div class="text-container">
				<h2>Überschrift</h2>
				<p>Das ist der Beschreibungstext zu diesem Block. Hier können detaillierte Informationen zum Thema stehen.</p>
				<a href="https://example.com" class="custom-button">Linkbutton so lang wie der Text</a>
			</div>
		</div>
